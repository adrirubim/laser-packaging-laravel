...
export const download = (
    args:
        | { palletizationInstruction: string | { uuid: string } }
        | [palletizationInstruction: string | { uuid: string }]
        | string
        | { uuid: string },
    options?: RouteQueryOptions,
...
download.url = (
    ...
    const parsedArgs = {
        palletizationInstruction:
            typeof args.palletizationInstruction === 'object'
    ...
    return (
        download.definition.url
            .replace(
                '{palletizationInstruction}',
                parsedArgs.palletizationInstruction.toString(),
            )
...
const palletizationInstructions = {
    generateIpNumber: Object.assign(generateIpNumber, generateIpNumber),
...
export default palletizationInstructions;
