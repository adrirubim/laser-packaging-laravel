...
import palletizationInstructions from './palletization-instructions'
import operationalInstructions from './operational-instructions'
import cqModels from './cq-models'
import palletSheets from './pallet-sheets'
/**
...
/**
* @see \App\Http\Controllers\ArticleController::downloadLineLayout
* @see app/Http/Controllers/ArticleController.php:600
* @route '/articles/{article}/download-line-layout'
*/
export const downloadLineLayout = (args: { article: string | { uuid: string } } | [article: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: downloadLineLayout.url(args, options),
    method: 'get',
})

downloadLineLayout.definition = {
    methods: ["get","head"],
...
* @route '/articles/{article}/download-line-layout'
*/
downloadLineLayout.url = (args: { article: string | { uuid: string } } | [article: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    ...
    return downloadLineLayout.definition.url
...
* @route '/articles/{article}/download-line-layout'
*/
downloadLineLayout.get = (args: { article: string | { uuid: string } } | [article: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: downloadLineLayout.url(args, options),
    method: 'get',
})
...
* @route '/articles/{article}/download-line-layout'
*/
downloadLineLayout.head = (args: { article: string | { uuid: string } } | [article: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: downloadLineLayout.url(args, options),
    method: 'head',
})
...
* @route '/articles/{article}/download-line-layout'
*/
const downloadLineLayoutForm = (args: { article: string | { uuid: string } } | [article: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: downloadLineLayout.url(args, options),
    method: 'get',
})
...
* @route '/articles/{article}/download-line-layout'
*/
downloadLineLayoutForm.get = (args: { article: string | { uuid: string } } | [article: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: downloadLineLayout.url(args, options),
    method: 'get',
})
...
* @route '/articles/{article}/download-line-layout'
*/
downloadLineLayoutForm.head = (args: { article: string | { uuid: string } } | [article: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: downloadLineLayout.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
downloadLineLayout.form = downloadLineLayoutForm
...
const articles = {
    packagingInstructions: Object.assign(packagingInstructions, packagingInstructions),
    palletizationInstructions: Object.assign(palletizationInstructions, palletizationInstructions),
    operationalInstructions: Object.assign(operationalInstructions, operationalInstructions),
    cqModels: Object.assign(cqModels, cqModels),
    palletSheets: Object.assign(palletSheets, palletSheets),
    getLasCode: Object.assign(getLasCode, getLasCode),
    downloadLineLayout: Object.assign(downloadLineLayout, downloadLineLayout),
