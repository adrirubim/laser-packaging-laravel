...
manageEmployees.url = (
    ...
    return (
        manageEmployees.definition.url
 ...
 * @see app/Http/Controllers/OrderController.php:394
...
downloadAutocontrollo.url = (
    ...
    return (
        downloadAutocontrollo.definition.url
            .replace('{order}', parsedArgs.order.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
...
const orders = {
    productionAdvancements: Object.assign(
        productionAdvancements,
        productionAdvancements,
    ),
    getShippingAddresses: Object.assign(
    ...
    downloadAutocontrollo: Object.assign(
        downloadAutocontrollo,
        downloadAutocontrollo,
    ),
