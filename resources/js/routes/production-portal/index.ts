...
*/
export const order = (args: { order: string | number } | [order: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/production-portal/order/{order}'
*/
order.url = (args: { order: string | number } | [order: string | number ] | string | number, options?: RouteQueryOptions) => {
...
* @route '/production-portal/order/{order}'
*/
order.get = (args: { order: string | number } | [order: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: order.url(args, options),
    method: 'get',
})
...
* @route '/production-portal/order/{order}'
*/
order.head = (args: { order: string | number } | [order: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: order.url(args, options),
    method: 'head',
})
...
* @route '/production-portal/order/{order}'
*/
const orderForm = (args: { order: string | number } | [order: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/production-portal/order/{order}'
*/
orderForm.get = (args: { order: string | number } | [order: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: order.url(args, options),
    method: 'get',
})
...
* @route '/production-portal/order/{order}'
*/
orderForm.head = (args: { order: string | number } | [order: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
