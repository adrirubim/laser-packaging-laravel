 ...
 * @see app/Http/Controllers/SupplierController.php:30
 * @route '/suppliers'
 */
 ...
 * @see app/Http/Controllers/SupplierController.php:64
 ...
 * @see app/Http/Controllers/SupplierController.php:88
 * @route '/suppliers/{supplier}'
 */
export const update = (
    args:
