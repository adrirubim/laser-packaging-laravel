...
export const show = (
    args:
        | { productionOrderProcessing: string | number }
        | [productionOrderProcessing: string | number]
        | string
        | number,
    options?: RouteQueryOptions,
    ...
    return (
        show.definition.url
            .replace(
                ...
                parsedArgs.productionOrderProcessing.toString(),
            )
...
export const destroy = (
    args:
        | { productionOrderProcessing: string | { uuid: string } }
        | [productionOrderProcessing: string | { uuid: string }]
        | string
        | { uuid: string },
    options?: RouteQueryOptions,
...
destroy.url = (
    ...
    const parsedArgs = {
        productionOrderProcessing:
            typeof args.productionOrderProcessing === 'object'
...
const productionOrderProcessing = {
...
export default productionOrderProcessing;
