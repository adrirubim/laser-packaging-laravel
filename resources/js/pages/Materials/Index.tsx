    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Elenco dei materiali attivi con Cerca.
                        </p>
                    </div>
                    <Link
                            ...
                            <tbody>
                                {materialsPaginated.data.length === 0 && (
                                    <tr>
                                        ...
                                        >
                                            Nessun materiale trovato per i
                                            filtri attuali.
                                        </td>
                                    </tr>
                                )}
                ...
                {materialsPaginated.links.length > 1 && (
                    <div className="flex items-center justify-between gap-3 text-xs text-muted-foreground">
                        <div>
                            Pagina {materialsPaginated.current_page} di{' '}
                            {materialsPaginated.last_page}
                        </div>
                        <div className="flex flex-wrap items-center gap-1">
                            {materialsPaginated.links.map((link, index) => {
                                if (
