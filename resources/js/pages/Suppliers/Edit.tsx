...
export default function SuppliersEdit({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: suppliers.edit({ supplier: supplier.uuid }).url,
        },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head
                title={t('suppliers.edit.page_title', {
                    code: supplier.code,
                })}
            />
                ...
                <div className="flex w-full justify-center">
                    <div className="w-full max-w-4xl space-y-5">
                        <Card>
                            <CardHeader>
                                <CardTitle>
                                    {t('suppliers.edit.card_title')}
                                </CardTitle>
                                <CardDescription>
                                    {t('suppliers.edit.card_description')}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Form
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent>
                                                                <p>
                                                                    {t(
                                                                        'suppliers.form.postal_code_tooltip',
                                                                    )}
                                                                </p>
                                                            </TooltipContent>
                                                        </Tooltip>
