            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Inserisci i dettagli per creare un nuovo modello
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Form
                                ...
                                return (
                                    <>
                                        <div className="grid gap-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Il codice modello è proposto
                                                automaticamente ma può essere
                                                modificato.
                                            </p>
                                            <InputError
                                                message={allErrors.cod_model}
                                            />
                                        </div>
