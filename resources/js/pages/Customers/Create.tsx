                                ...
                                return (
                                    <>
                                        <div className="grid gap-2">
                                            ...
                                            >
                                                Inserisci il codice univoco del
                                                cliente (massimo 255 caratteri).
                                            </p>
                                            <InputError
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <p
                                                ...
                                                className="text-xs text-muted-foreground"
                                            >
                                                Inserisci la ragione sociale del
                                                cliente (massimo 255 caratteri).
                                            </p>
                                            <InputError
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <p
                                                ...
                                                className="text-xs text-muted-foreground"
                                            >
                                                Inserisci la città (massimo 255
                                                caratteri).
                                            </p>
                                            <InputError
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <p
                                                ...
                                                className="text-xs text-muted-foreground"
                                            >
                                                Inserisci il codice provincia di
                                                2 lettere maiuscole (es: RM, MI,
                                                TO).
                                            </p>
                                            <InputError
