...
*/
export const show = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/article-categories/{articleCategory}'
*/
show.url = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
        articleCategory: typeof args.articleCategory === 'object'
...
* @route '/article-categories/{articleCategory}'
*/
show.get = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show.url(args, options),
    method: 'get',
})
...
* @route '/article-categories/{articleCategory}'
*/
show.head = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: show.url(args, options),
    method: 'head',
})
...
*/
export const edit = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/article-categories/{articleCategory}/edit'
*/
edit.url = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { articleCategory: args }
    }
...
* @route '/article-categories/{articleCategory}/edit'
*/
edit.get = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: edit.url(args, options),
    method: 'get',
})
...
* @route '/article-categories/{articleCategory}/edit'
*/
edit.head = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: edit.url(args, options),
    method: 'head',
})
...
* @route '/article-categories/{articleCategory}'
*/
export const update = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/article-categories/{articleCategory}'
*/
update.url = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { articleCategory: args }
    }
...
* @route '/article-categories/{articleCategory}'
*/
update.put = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update.url(args, options),
    method: 'put',
})
...
* @route '/article-categories/{articleCategory}'
*/
update.patch = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update.url(args, options),
    method: 'patch',
})
...
* @route '/article-categories/{articleCategory}'
*/
export const destroy = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/article-categories/{articleCategory}'
*/
destroy.url = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { articleCategory: args }
    }
...
* @route '/article-categories/{articleCategory}'
*/
destroy.delete = (args: { articleCategory: string | { uuid: string } } | [articleCategory: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
    method: 'delete',
})
