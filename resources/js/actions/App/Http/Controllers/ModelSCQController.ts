...
*/
export const generateCQUNumber = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/articles/cq-models/generate-cqu-number'
*/
generateCQUNumber.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: generateCQUNumber.url(options),
    method: 'get',
})
...
* @route '/articles/cq-models/generate-cqu-number'
*/
generateCQUNumber.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: generateCQUNumber.url(options),
    method: 'head',
})
...
*/
export const downloadFile = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/articles/cq-models/{cqModel}/download-file'
*/
downloadFile.url = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
        cqModel: typeof args.cqModel === 'object'
        ? args.cqModel.uuid
        : args.cqModel,
    }
...
* @route '/articles/cq-models/{cqModel}/download-file'
*/
downloadFile.get = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: downloadFile.url(args, options),
    method: 'get',
})
...
* @route '/articles/cq-models/{cqModel}/download-file'
*/
downloadFile.head = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: downloadFile.url(args, options),
    method: 'head',
})
...
*/
export const show = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/articles/cq-models/{cqModel}'
*/
show.url = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { cqModel: args }
    }
...
* @route '/articles/cq-models/{cqModel}'
*/
show.get = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show.url(args, options),
    method: 'get',
})
...
* @route '/articles/cq-models/{cqModel}'
*/
show.head = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: show.url(args, options),
    method: 'head',
})
...
*/
export const edit = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/articles/cq-models/{cqModel}/edit'
*/
edit.url = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { cqModel: args }
    }
...
* @route '/articles/cq-models/{cqModel}/edit'
*/
edit.get = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: edit.url(args, options),
    method: 'get',
})
...
* @route '/articles/cq-models/{cqModel}/edit'
*/
edit.head = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: edit.url(args, options),
    method: 'head',
})
...
* @route '/articles/cq-models/{cqModel}'
*/
export const update = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/articles/cq-models/{cqModel}'
*/
update.url = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { cqModel: args }
    }
...
* @route '/articles/cq-models/{cqModel}'
*/
update.put = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update.url(args, options),
    method: 'put',
})
...
* @route '/articles/cq-models/{cqModel}'
*/
update.patch = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update.url(args, options),
    method: 'patch',
})
...
* @route '/articles/cq-models/{cqModel}'
*/
export const destroy = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/articles/cq-models/{cqModel}'
*/
destroy.url = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { cqModel: args }
    }
...
* @route '/articles/cq-models/{cqModel}'
*/
destroy.delete = (args: { cqModel: string | { uuid: string } } | [cqModel: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
    method: 'delete',
})
...
const ModelSCQController = { generateCQUNumber, downloadFile, index, create, store, show, edit, update, destroy }
