...
export const show = (
    args:
        | { customerShippingAddress: string | { uuid: string } }
        | [customerShippingAddress: string | { uuid: string }]
        | string
        | { uuid: string },
    options?: RouteQueryOptions,
...
show.url = (
    ...
    const parsedArgs = {
        customerShippingAddress:
            typeof args.customerShippingAddress === 'object'
    ...
    return (
        show.definition.url
            .replace(
                '{customerShippingAddress}',
                parsedArgs.customerShippingAddress.toString(),
            )
...
const CustomerShippingAddressController = {
    loadDivisions,
    index,
    create,
    store,
...
export default CustomerShippingAddressController;
