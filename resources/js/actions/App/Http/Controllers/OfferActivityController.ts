...
*/
export const show = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/offers/activities/{offerActivity}'
*/
show.url = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
        offerActivity: typeof args.offerActivity === 'object'
...
* @route '/offers/activities/{offerActivity}'
*/
show.get = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: show.url(args, options),
    method: 'get',
})
...
* @route '/offers/activities/{offerActivity}'
*/
show.head = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: show.url(args, options),
    method: 'head',
})
...
*/
export const edit = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/offers/activities/{offerActivity}/edit'
*/
edit.url = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { offerActivity: args }
    }
...
* @route '/offers/activities/{offerActivity}/edit'
*/
edit.get = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: edit.url(args, options),
    method: 'get',
})
...
* @route '/offers/activities/{offerActivity}/edit'
*/
edit.head = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: edit.url(args, options),
    method: 'head',
})
...
* @route '/offers/activities/{offerActivity}'
*/
export const update = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/offers/activities/{offerActivity}'
*/
update.url = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { offerActivity: args }
    }
...
* @route '/offers/activities/{offerActivity}'
*/
update.put = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update.url(args, options),
    method: 'put',
})
...
* @route '/offers/activities/{offerActivity}'
*/
update.patch = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update.url(args, options),
    method: 'patch',
})
...
* @route '/offers/activities/{offerActivity}'
*/
export const destroy = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/offers/activities/{offerActivity}'
*/
destroy.url = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { offerActivity: args }
    }
...
* @route '/offers/activities/{offerActivity}'
*/
destroy.delete = (args: { offerActivity: string | { uuid: string } } | [offerActivity: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
    method: 'delete',
})
...
const OfferActivityController = { index, create, store, show, edit, update, destroy }
