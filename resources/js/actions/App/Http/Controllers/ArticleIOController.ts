...
export const download = (
    args:
        | { operationalInstruction: string | { uuid: string } }
        | [operationalInstruction: string | { uuid: string }]
        | string
        | { uuid: string },
    options?: RouteQueryOptions,
...
download.url = (
    ...
    const parsedArgs = {
        operationalInstruction:
            typeof args.operationalInstruction === 'object'
    ...
    return (
        download.definition.url
            .replace(
                '{operationalInstruction}',
                parsedArgs.operationalInstruction.toString(),
            )
...
export default ArticleIOController;
