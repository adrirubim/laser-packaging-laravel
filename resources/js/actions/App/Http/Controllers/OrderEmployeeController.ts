...
manageOrder.url = (
    ...
    const parsedArgs = {
        order: typeof args.order === 'object' ? args.order.uuid : args.order,
    };

    return (
        manageOrder.definition.url
 ...
 * @route '/order-employees/get-assignments'
 */
const getEmployeeAssignmentsForm = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 * @route '/order-employees/get-assignments'
 */
getEmployeeAssignmentsForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: getEmployeeAssignments.url(options),
    method: 'get',
 ...
 * @route '/order-employees/get-assignments'
 */
getEmployeeAssignmentsForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
 ...
 */
export const saveEmployeeAssignments = (
    options?: RouteQueryOptions,
 ...
 * @route '/order-employees/save-assignments'
 */
const saveEmployeeAssignmentsForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/order-employees/save-assignments'
 */
saveEmployeeAssignmentsForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: saveEmployeeAssignments.url(options),
    method: 'post',
 ...
 */
export const checkEmployeeOrder = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
