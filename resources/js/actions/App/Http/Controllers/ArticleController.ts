 ...
 */
export const downloadLineLayoutFile = (
    args:
...
downloadLineLayoutFile.url = (
    ...
    return (
        downloadLineLayoutFile.definition.url
 ...
 * @route '/articles/{article}/download-line-layout'
 */
const downloadLineLayoutFileForm = (
    args:
        | { article: string | { uuid: string } }
        | [article: string | { uuid: string }]
        | string
 ...
 * @route '/articles/{article}/download-line-layout'
 */
downloadLineLayoutFileForm.get = (
    args:
        | { article: string | { uuid: string } }
        | [article: string | { uuid: string }]
        | string
 ...
 * @route '/articles/{article}/download-line-layout'
 */
downloadLineLayoutFileForm.head = (
    args:
        | { article: string | { uuid: string } }
        | [article: string | { uuid: string }]
        | string
