...
**Stack:** [VERSION_STACK.md](VERSION_STACK.md) · **Full status:** [../README.md#project-status](../README.md#project-status)
...
| Demo data | `TestDataSeeder` in [DATABASE.md](DATABASE.md) |
